...
const DICT = {
  en: {
    ...
    plColor: "Colour",
    plColorPick: "Pick colour {c}",
    plStampPrev: "Previous palang",
    plStampNext: "Next palang",
    plRendering: "Rendering page {n}…",
    plNoPreview: "This page can\u2019t be previewed: the marking is still placed at its true size.",
    plRemoveStamp: "Remove this palang",
  ...
  ms: {
    ...
    plColor: "Warna",
    plColorPick: "Pilih warna {c}",
    plStampPrev: "Palang sebelum",
    plStampNext: "Palang seterusnya",
    plRendering: "Memaparkan halaman {n}…",
    plNoPreview: "Halaman ini tidak dapat dipratonton: palang tetap diletak pada saiz sebenar.",
    plRemoveStamp: "Buang palang ini",
